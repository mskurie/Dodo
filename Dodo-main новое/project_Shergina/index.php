...
$today_reservations_result = $conn->query("SELECT COUNT(*) as cnt FROM reservations WHERE DATE(reservation_time) = '$today'");
...
$dishes_count_result = $conn->query("SELECT COUNT(*) as cnt FROM dishes WHERE is_available = 1");
$dishes_count = $dishes_count_result ? $dishes_count_result->fetch_assoc()['cnt'] : 0;
?>
<!DOCTYPE html>
<html lang="ru">
<head>
